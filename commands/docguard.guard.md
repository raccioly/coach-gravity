---
description: Run DocGuard guard validation — check project documentation against CDD standards with 15 validators
handoffs:
...
2. **Parse the output**. Each of the 15 validators reports ✅ (pass), ⚠️ (warning), or ❌ (fail):
