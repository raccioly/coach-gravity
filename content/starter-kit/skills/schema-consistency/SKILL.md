...
description: Schema consistency enforcer that ensures Zod schemas, TypeScript types, OpenAPI spec, and database models stay in sync. Activate when checking schema sync, auditing Zod TypeScript OpenAPI consistency, detecting type consistency drift, comparing frontend and backend types, or verifying DynamoDB key patterns match type definitions.
